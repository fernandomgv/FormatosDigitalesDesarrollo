$( document ).ready(function() {
	...
	$('#btncontacto').bind('click', function(e) {
                e.preventDefault();
	...
	/*
	$('#home-convocatoria').bind('click', function(e) {
                e.preventDefault();
                 $('#visoriframe').bPopup({
            content:'iframe', //'iframe' or 'ajax'
            
            loadUrl:'http://energiayambienteandinanew.pe.iica.int/inicio/convocatoria-aea.aspx' //Uses jQuery.load()
        });
    });
	*/
