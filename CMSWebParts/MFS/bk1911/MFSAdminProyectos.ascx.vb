...
Partial Class CMSWebParts_MFS_MFSAdminProyectos
    ...
    Private Sub admpaneles(ByVal opc As Integer)
        Select Case opc
            ...
            Case 2 ' mostrar informacion proponente
                ...
                Me.btnInfoentidad.Text = "[+] Mostrar Informacion de Entidad Proponente"
                PnlregistroProyecto.Visible = False
            ...
            Case 4
                ...
                Me.btnInfoentidad.Text = "[-] Ocultar Informacion de Entidad Proponente"
            Case 5
    ...
    Private Sub solicitainfoproponente()
        ...
        Me.lblmensajeproponente.Text = "Usted aun no registrado la Informacion necesaria para poder registrar sus proyectos :" + vbCr + "Favor ingresa los datos solicitados en el siguiente formulario"
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                ...
                Dim ctrlAdmin As ImageButton = CType(e.Row.Cells(0).Controls(0), ImageButton)
    ...
    Private Sub Mensaje(ByVal cad As String)
        ...
        Me.Panel1.Attributes("style") = "position:fixed; top:50%; left:50%; width:30em; height:em; margin-top: -9em; margin-left: -15em; z-index:3; border:3px solid #d2b48c; padding:20px; background-color:#fafad2; display:block;   "
    ...
    Protected Sub ImageButton7_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton7.Click
        If Me.Panel2.Visible = True Then
            ...
            Me.ImageButton7.ImageUrl = "~/App_Themes/CorporateSite/Images/add.gif"
            Me.ImageButton7.ToolTip = "Mostrar Ayuda"
        Else
            Me.Panel2.Visible = True

            Me.ImageButton7.ImageUrl = "~/App_Themes/CorporateSite/Images/delete.gif"
            Me.ImageButton7.ToolTip = "Ocultar Ayuda"
        End If
