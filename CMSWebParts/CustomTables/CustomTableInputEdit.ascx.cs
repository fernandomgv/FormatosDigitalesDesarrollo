...
public partial class CMSWebParts_CustomTables_CustomTableInputEdit : CMSAbstractWebPart
{
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            {
                // Get form info
                dci = DataClassInfoProvider.GetDataClass(CustomTableName);
            ...
            customTableForm.BasicForm.SubmitButton.CssClass = SubmitButtonCssClass;
            customTableForm.BasicForm.SubmitButton.Text = SubmitButtonText;
        }
    }
