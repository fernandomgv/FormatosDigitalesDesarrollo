...
public partial class CMSModules_CustomTables_Tools_CustomTable_Data_EditItem : CMSCustomTablesToolsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int territorio = QueryHelper.GetInteger("territorio", 0);
        if (customTableId > 0)
        {
            ...
            if (dci != null)
            {
                ...
                if (QueryHelper.GetString("saved", String.Empty) != String.Empty)
                {
                    ...
                    if ((QueryHelper.GetString("new", String.Empty) != String.Empty))
                    {
                        ...
                        actions[0, 2] = null;
                        actions[0, 3] = ResolveUrl(newItemPage + "?new=1&customtableid=" + customTableId + (siteManager ? "&sm=1" : String.Empty) + "&territorio=" + territorio);
                        actions[0, 4] = null;
                ...
                breadcrumbs[0, 1] = listPage + "?customtableid=" + customTableId + (siteManager ? "&sm=1" : String.Empty) + "&territorio=" + territorio;
                ...
                if (accessGranted)
                {
                    ...
                    customTableForm.EditItemPageAdditionalParams = (siteManager ? "sm=1" : String.Empty) + "&territorio=" + territorio;
                }
            }
        }
    }
