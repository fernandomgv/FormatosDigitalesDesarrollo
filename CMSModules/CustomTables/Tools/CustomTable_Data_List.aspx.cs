...
public partial class CMSModules_CustomTables_Tools_CustomTable_Data_List : CMSCustomTablesToolsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        territorio = QueryHelper.GetInteger("territorio", 0);
        ...
        if (dci != null)
        {
            ...
            customTableDataList.EditItemPageAdditionalParams = (siteManager ? "sm=1" : String.Empty) + "&territorio=" + territorio;
            customTableDataList.ViewItemPageAdditionalParams = (siteManager ? "sm=1" : String.Empty) + "&territorio=" + territorio;
            ...
            ScriptHelper.RegisterClientScriptBlock(this, typeof(string), "SelectFields", ScriptHelper.GetScript("function SelectFields() { modalDialog('" +
                ResolveUrl("~/CMSModules/CustomTables/Tools/CustomTable_Data_SelectFields.aspx") + "?customtableid=" + customTableId + "&territorio=" + territorio + "'  ,'CustomTableFields', 500, 500); }"));
            ...
            actions[0, 2] = null;
            actions[0, 3] = ResolveUrl(newItemPage + "?new=1&customtableid=" + customTableId + (siteManager ? "&sm=1" : "")+ "&territorio="+ territorio);
            actions[0, 4] = null;
