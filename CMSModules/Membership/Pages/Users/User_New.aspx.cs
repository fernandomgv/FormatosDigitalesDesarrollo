...
public partial class CMSModules_Membership_Pages_Users_User_New : CMSUsersPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        pageTitleTabs[0, 1] = "~/CMSModules/Membership/Pages/Users/Users_Frameset.aspx?siteid=" + SiteID +"&territorio="+territorio;
            ...
            if (TextBoxConfirmPassword.Text == passStrength.Text)
            {
                ...
                if (passStrength.IsValid())
                {
                    if (UserInfoProvider.GetUserInfo(userName) == null)
                    {
                        ...
                        {
                            var territorio = QueryHelper.GetInteger("territorio", 0);
                            URLHelper.Redirect("User_Edit_Frameset.aspx?userId=" + userId + "&siteid=" + SiteID + "&territorio="+territorio);
                        }
                    }
                    else
                    {
    ...
    protected int SaveNewUser()
    {
        ...
        var territorio = QueryHelper.GetInteger("territorio", 0);
        ui.SetValue("territorioId", territorio);
