...
public partial class CMSModules_Membership_Pages_Users_User_Edit : CMSUsersPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        pageTitleTabs[0, 1] = "~/CMSModules/Membership/Pages/Users/User_List.aspx?siteid=" + SiteID + "&territorio=" + territorio;
    ...
    protected void InitalizeMenu()
    {
        ...
        if (customFieldsTab > 0)
        {
            ...
            tabs[lastTabIndex, 2] = "User_Edit_CustomFields.aspx?userid=" + userId + "&siteid=" + SiteID + "&territorio=" + territorio;
        }
